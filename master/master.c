...
{
    if(ec_master_idle_thread_in == 0){
        set_cpus_chang();
        ec_master_idle_thread_in = 1;       
    }
...
{
    if(ec_master_operation_thread_in == 0){
        set_cpus_chang();
        ec_master_operation_thread_in = 1;       
    }
...
{
#ifdef EC_EOE  
    if(ec_master_eoe_thread_in == 0){
        set_cpus_chang();
        ec_master_eoe_thread_thread = 1;       
    }    
    ec_master_t *master = (ec_master_t *) priv_data;
    ec_eoe_t *eoe;
